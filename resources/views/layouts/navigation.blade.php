@php
    $navLinks = [
        ...
        [
            ...
            'active' => ['accounting-documents.*', 'financial-transactions.*', 'financial-reports.*', 'bank-accounts.*', 'treasury.*', 'fiscal-periods.*'],
            'children' => [
                ['label' => 'ثبت سند حسابداری', 'route' => 'accounting-documents.create'],
                ['label' => 'ثبت هزینه و درآمد', 'route' => 'financial-transactions.create'],
                ['label' => 'تعریف بانک', 'route' => 'bank-accounts.index'],
                ['label' => 'مرکز گزارش‌های مالی', 'route' => 'financial-reports.index'],
                ['label' => 'گزارش جمع‌بندی مالی', 'route' => 'financial-transactions.summary'],
                ...
                ['label' => 'صورتحساب بانک', 'route' => 'financial-reports.show', 'params' => ['report' => 'bank-statement']],
